module Kubernetes.Api.Rbac.V1Alpha1.ClusterRole where
...
create :: forall e. Config -> RbacV1Alpha1.ClusterRole -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
...
delete cfg body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}" <> Client.formatQueryString options
    encodedBody = encodeJSON body
...
deleteCollection cfg options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" <> Client.formatQueryString options
...
list :: forall e. Config -> ListOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRoleList)
list cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" <> Client.formatQueryString options

-- | read the specified ClusterRole
read :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
...
replace :: forall e. Config -> RbacV1Alpha1.ClusterRole -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
