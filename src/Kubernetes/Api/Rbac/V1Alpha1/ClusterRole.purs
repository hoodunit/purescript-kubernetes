...
create :: Config -> RbacV1Alpha1.ClusterRole -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRoleList)
list cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" <> Client.formatQueryString options

-- | read the specified ClusterRole
read :: Config -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
...
replace :: Config -> RbacV1Alpha1.ClusterRole -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRole)
