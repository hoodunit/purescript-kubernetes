...
create :: Config -> RbacV1Alpha1.ClusterRoleBinding -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBindingList)
list cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings" <> Client.formatQueryString options

-- | read the specified ClusterRoleBinding
read :: Config -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
...
replace :: Config -> RbacV1Alpha1.ClusterRoleBinding -> Aff (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
