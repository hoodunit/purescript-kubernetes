...
createNamespaced :: Config -> RbacV1Beta1.RoleBinding -> Aff (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
...
-- | list or watch objects of kind RoleBinding
listNamespaced :: Config -> ListNamespacedOptions -> Aff (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
listNamespaced cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings" <> Client.formatQueryString options

-- | read the specified RoleBinding
readNamespaced :: Config -> Aff (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
replaceNamespaced :: Config -> RbacV1Beta1.RoleBinding -> Aff (Either MetaV1.Status RbacV1Beta1.RoleBinding)
