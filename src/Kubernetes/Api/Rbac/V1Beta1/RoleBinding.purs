module Kubernetes.Api.Rbac.V1Beta1.RoleBinding where
...
import Kubernetes.Api.Rbac.V1Beta1 as RbacV1Beta1

-- | create a RoleBinding
createNamespaced :: forall e. Config -> RbacV1Beta1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
deleteCollectionNamespaced cfg options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings" <> Client.formatQueryString options
...
deleteNamespaced cfg body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind RoleBinding
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
...
-- | list or watch objects of kind RoleBinding
listNamespaced :: forall e. Config -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
listNamespaced cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings" <> Client.formatQueryString options

-- | read the specified RoleBinding
readNamespaced :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
replaceNamespaced :: forall e. Config -> RbacV1Beta1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
