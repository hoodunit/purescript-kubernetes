module Kubernetes.Api.Rbac.V1Beta1.ClusterRole where
...
create :: Config -> RbacV1Beta1.ClusterRole -> Aff (Either MetaV1.Status RbacV1Beta1.ClusterRole)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status RbacV1Beta1.ClusterRoleList)
list cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles" <> Client.formatQueryString options

-- | read the specified ClusterRole
read :: Config -> Aff (Either MetaV1.Status RbacV1Beta1.ClusterRole)
read cfg = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}"

-- | replace the specified ClusterRole
replace :: Config -> RbacV1Beta1.ClusterRole -> Aff (Either MetaV1.Status RbacV1Beta1.ClusterRole)
