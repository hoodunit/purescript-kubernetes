...
create :: Config -> RbacV1.ClusterRoleBinding -> Aff (Either MetaV1.Status RbacV1.ClusterRoleBinding)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status RbacV1.ClusterRoleBindingList)
list cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings" <> Client.formatQueryString options

-- | read the specified ClusterRoleBinding
read :: Config -> Aff (Either MetaV1.Status RbacV1.ClusterRoleBinding)
...
replace :: Config -> RbacV1.ClusterRoleBinding -> Aff (Either MetaV1.Status RbacV1.ClusterRoleBinding)
