...
-- | create a PodPreset
createNamespaced :: Config -> SettingsV1Alpha1.PodPreset -> Aff (Either MetaV1.Status SettingsV1Alpha1.PodPreset)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status SettingsV1Alpha1.PodPresetList)
...
-- | list or watch objects of kind PodPreset
listNamespaced :: Config -> ListNamespacedOptions -> Aff (Either MetaV1.Status SettingsV1Alpha1.PodPresetList)
...
readNamespaced :: Config -> ReadNamespacedOptions -> Aff (Either MetaV1.Status SettingsV1Alpha1.PodPreset)
readNamespaced cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}" <> Client.formatQueryString options

-- | replace the specified PodPreset
replaceNamespaced :: Config -> SettingsV1Alpha1.PodPreset -> Aff (Either MetaV1.Status SettingsV1Alpha1.PodPreset)
