...
createNamespaced :: Config -> String -> AppsV1Beta2.StatefulSet -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSet)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSetList)
...
-- | list or watch objects of kind StatefulSet
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSetList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/statefulsets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified StatefulSet
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSet)
...
replaceNamespaced :: Config -> String -> String -> AppsV1Beta2.StatefulSet -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSet)
...
replaceNamespacedStatus :: Config -> String -> String -> AppsV1Beta2.StatefulSet -> Aff (Either MetaV1.Status AppsV1Beta2.StatefulSet)
