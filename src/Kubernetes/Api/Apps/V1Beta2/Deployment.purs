module Kubernetes.Api.Apps.V1Beta2.Deployment where
...
-- | create a Deployment
createNamespaced :: forall e. Config -> String -> AppsV1Beta2.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.Deployment)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/deployments" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind Deployment
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.DeploymentList)
...
-- | list or watch objects of kind Deployment
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.DeploymentList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.Deployment)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Deployment
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.Deployment)
...
replaceNamespaced :: forall e. Config -> String -> String -> AppsV1Beta2.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.Deployment)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> AppsV1Beta2.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.Deployment)
