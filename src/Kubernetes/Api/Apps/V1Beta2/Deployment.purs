...
-- | create a Deployment
createNamespaced :: Config -> String -> AppsV1Beta2.Deployment -> Aff (Either MetaV1.Status AppsV1Beta2.Deployment)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status AppsV1Beta2.DeploymentList)
...
-- | list or watch objects of kind Deployment
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.DeploymentList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.Deployment)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Deployment
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status AppsV1Beta2.Deployment)
...
replaceNamespaced :: Config -> String -> String -> AppsV1Beta2.Deployment -> Aff (Either MetaV1.Status AppsV1Beta2.Deployment)
...
replaceNamespacedStatus :: Config -> String -> String -> AppsV1Beta2.Deployment -> Aff (Either MetaV1.Status AppsV1Beta2.Deployment)
