...
-- | create a DaemonSet
createNamespaced :: Config -> String -> AppsV1Beta2.DaemonSet -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSet)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSetList)
...
-- | list or watch objects of kind DaemonSet
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSetList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/daemonsets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified DaemonSet
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSet)
...
replaceNamespaced :: Config -> String -> String -> AppsV1Beta2.DaemonSet -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSet)
...
replaceNamespacedStatus :: Config -> String -> String -> AppsV1Beta2.DaemonSet -> Aff (Either MetaV1.Status AppsV1Beta2.DaemonSet)
