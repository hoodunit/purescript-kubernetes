...
-- | create a ReplicaSet
createNamespaced :: Config -> String -> AppsV1.ReplicaSet -> Aff (Either MetaV1.Status AppsV1.ReplicaSet)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status AppsV1.ReplicaSetList)
...
-- | list or watch objects of kind ReplicaSet
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status AppsV1.ReplicaSetList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status AppsV1.ReplicaSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ReplicaSet
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespaced :: Config -> String -> String -> AppsV1.ReplicaSet -> Aff (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespacedStatus :: Config -> String -> String -> AppsV1.ReplicaSet -> Aff (Either MetaV1.Status AppsV1.ReplicaSet)
