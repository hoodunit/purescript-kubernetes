module Kubernetes.Api.Apps.V1.ReplicaSet where
...
-- | create a ReplicaSet
createNamespaced :: forall e. Config -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind ReplicaSet
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSetList)
...
-- | list or watch objects of kind ReplicaSet
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSetList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ReplicaSet
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespaced :: forall e. Config -> String -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
