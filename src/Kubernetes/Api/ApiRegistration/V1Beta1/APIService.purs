...
create :: Config -> ApiRegistrationV1Beta1.APIService -> Aff (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status ApiRegistrationV1Beta1.APIServiceList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}" <> Client.formatQueryString options

-- | replace the specified APIService
replace :: Config -> ApiRegistrationV1Beta1.APIService -> Aff (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
...
replaceStatus :: Config -> ApiRegistrationV1Beta1.APIService -> Aff (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
