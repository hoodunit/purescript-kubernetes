module Kubernetes.Api.ApiRegistration.V1Beta1.APIService where
...
import Kubernetes.Api.ApiRegistration.V1Beta1 as ApiRegistrationV1Beta1
import Kubernetes.Api.Meta.V1 as MetaV1

-- | create an APIService
create :: forall e. Config -> ApiRegistrationV1Beta1.APIService -> Aff (http :: HTTP | e) (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
...
delete cfg body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}" <> Client.formatQueryString options
    encodedBody = encodeJSON body
...
deleteCollection cfg options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/apiregistration.k8s.io/v1beta1/apiservices" <> Client.formatQueryString options
...
list :: forall e. Config -> ListOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status ApiRegistrationV1Beta1.APIServiceList)
...
read :: forall e. Config -> ReadOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}" <> Client.formatQueryString options

-- | replace the specified APIService
replace :: forall e. Config -> ApiRegistrationV1Beta1.APIService -> Aff (http :: HTTP | e) (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
...
replaceStatus :: forall e. Config -> ApiRegistrationV1Beta1.APIService -> Aff (http :: HTTP | e) (Either MetaV1.Status ApiRegistrationV1Beta1.APIService)
