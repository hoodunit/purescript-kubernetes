...
createNamespaced :: Config -> String -> PolicyV1Beta1.PodDisruptionBudget -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudget)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudgetList)
...
-- | list or watch objects of kind PodDisruptionBudget
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudgetList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudget)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/policy/v1beta1/namespaces/" <> namespace <> "/poddisruptionbudgets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified PodDisruptionBudget
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudget)
...
replaceNamespaced :: Config -> String -> String -> PolicyV1Beta1.PodDisruptionBudget -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudget)
...
replaceNamespacedStatus :: Config -> String -> String -> PolicyV1Beta1.PodDisruptionBudget -> Aff (Either MetaV1.Status PolicyV1Beta1.PodDisruptionBudget)
