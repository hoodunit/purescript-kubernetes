...
createNamespacedControllerRevision :: forall e. Config -> String -> AppsV1Beta2.ControllerRevision -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.ControllerRevision)
...
listControllerRevisionForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.ControllerRevisionList)
...
-- | list or watch objects of kind ControllerRevision
listNamespacedControllerRevision :: forall e. Config -> String -> ListNamespacedControllerRevisionOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.ControllerRevisionList)
...
readNamespacedControllerRevision :: forall e. Config -> String -> String -> ReadNamespacedControllerRevisionOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.ControllerRevision)
readNamespacedControllerRevision cfg namespace name options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1beta2/namespaces/" <> namespace <> "/controllerrevisions/" <> name <> "" <> formatQueryString options

-- | replace the specified ControllerRevision
replaceNamespacedControllerRevision :: forall e. Config -> String -> String -> AppsV1Beta2.ControllerRevision -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta2.ControllerRevision)
