...
create :: Config -> AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration -> Aff (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfigurationList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}" <> Client.formatQueryString options

-- | replace the specified MutatingWebhookConfiguration
replace :: Config -> AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration -> Aff (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
