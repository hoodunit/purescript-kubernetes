module Kubernetes.Api.AdmissionRegistration.V1Beta1.MutatingWebhookConfiguration where
...
import Kubernetes.Api.AdmissionRegistration.V1Beta1 as AdmissionRegistrationV1Beta1
import Kubernetes.Api.Meta.V1 as MetaV1

-- | create a MutatingWebhookConfiguration
create :: forall e. Config -> AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration -> Aff (http :: HTTP | e) (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
...
delete cfg body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}" <> Client.formatQueryString options
    encodedBody = encodeJSON body
...
deleteCollection cfg options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations" <> Client.formatQueryString options
...
list :: forall e. Config -> ListOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfigurationList)
...
read :: forall e. Config -> ReadOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}" <> Client.formatQueryString options

-- | replace the specified MutatingWebhookConfiguration
replace :: forall e. Config -> AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration -> Aff (http :: HTTP | e) (Either MetaV1.Status AdmissionRegistrationV1Beta1.MutatingWebhookConfiguration)
