...
create :: Config -> AdmissionRegistrationV1Alpha1.InitializerConfiguration -> Aff (Either MetaV1.Status AdmissionRegistrationV1Alpha1.InitializerConfiguration)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status AdmissionRegistrationV1Alpha1.InitializerConfigurationList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status AdmissionRegistrationV1Alpha1.InitializerConfiguration)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/admissionregistration.k8s.io/v1alpha1/initializerconfigurations/{name}" <> Client.formatQueryString options

-- | replace the specified InitializerConfiguration
replace :: Config -> AdmissionRegistrationV1Alpha1.InitializerConfiguration -> Aff (Either MetaV1.Status AdmissionRegistrationV1Alpha1.InitializerConfiguration)
