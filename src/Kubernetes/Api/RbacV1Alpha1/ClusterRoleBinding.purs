...
createClusterRoleBinding :: forall e. Config -> RbacV1Alpha1.ClusterRoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
...
listClusterRoleBinding :: forall e. Config -> ListClusterRoleBindingOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBindingList)
listClusterRoleBinding cfg options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings" <> formatQueryString options

-- | read the specified ClusterRoleBinding
readClusterRoleBinding :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
...
replaceClusterRoleBinding :: forall e. Config -> RbacV1Alpha1.ClusterRoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.ClusterRoleBinding)
