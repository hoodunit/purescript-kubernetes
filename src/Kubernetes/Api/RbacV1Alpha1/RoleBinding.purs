module Kubernetes.Api.RbacV1Alpha1.RoleBinding where
...
createNamespacedRoleBinding :: forall e. Config -> RbacV1Alpha1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
...
listNamespacedRoleBinding :: forall e. Config -> ListNamespacedRoleBindingOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBindingList)
listNamespacedRoleBinding cfg options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings" <> formatQueryString options

-- | list or watch objects of kind RoleBinding
listRoleBindingForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBindingList)
...
readNamespacedRoleBinding :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
...
replaceNamespacedRoleBinding :: forall e. Config -> RbacV1Alpha1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
