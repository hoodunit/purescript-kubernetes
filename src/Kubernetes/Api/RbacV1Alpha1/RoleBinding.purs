...
createNamespaced :: forall e. Config -> RbacV1Alpha1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
...
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBindingList)
...
-- | list or watch objects of kind RoleBinding
listNamespaced :: forall e. Config -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBindingList)
listNamespaced cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings" <> Client.formatQueryString options

-- | read the specified RoleBinding
readNamespaced :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
...
replaceNamespaced :: forall e. Config -> RbacV1Alpha1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Alpha1.RoleBinding)
