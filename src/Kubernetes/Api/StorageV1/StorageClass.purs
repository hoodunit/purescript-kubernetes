module Kubernetes.Api.StorageV1.StorageClass where
...
import Kubernetes.Api.StorageV1 as StorageV1

-- | create a StorageClass
createStorageClass :: forall e. Config -> StorageV1.StorageClass -> Aff (http :: HTTP | e) (Either MetaV1.Status StorageV1.StorageClass)
...
deleteCollectionStorageClass cfg options = makeRequest (delete cfg url Nothing)
  where
    url = "/apis/storage.k8s.io/v1/storageclasses" <> formatQueryString options
...
deleteStorageClass cfg body options = makeRequest (delete cfg url (Just encodedBody))
  where
    url = "/apis/storage.k8s.io/v1/storageclasses/{name}" <> formatQueryString options
    encodedBody = encodeJSON body
...
listStorageClass :: forall e. Config -> ListStorageClassOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status StorageV1.StorageClassList)
...
readStorageClass :: forall e. Config -> ReadStorageClassOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status StorageV1.StorageClass)
readStorageClass cfg options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/storage.k8s.io/v1/storageclasses/{name}" <> formatQueryString options

-- | replace the specified StorageClass
replaceStorageClass :: forall e. Config -> StorageV1.StorageClass -> Aff (http :: HTTP | e) (Either MetaV1.Status StorageV1.StorageClass)
