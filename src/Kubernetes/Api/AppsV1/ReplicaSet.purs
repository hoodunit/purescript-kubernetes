...
-- | create a ReplicaSet
createNamespacedReplicaSet :: forall e. Config -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
listNamespacedReplicaSet :: forall e. Config -> String -> ListNamespacedReplicaSetOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSetList)
listNamespacedReplicaSet cfg namespace options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets" <> formatQueryString options

-- | list or watch objects of kind ReplicaSet
listReplicaSetForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSetList)
...
readNamespacedReplicaSet :: forall e. Config -> String -> String -> ReadNamespacedReplicaSetOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
readNamespacedReplicaSet cfg namespace name options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/replicasets/" <> name <> "" <> formatQueryString options

-- | read status of the specified ReplicaSet
readNamespacedReplicaSetStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespacedReplicaSet :: forall e. Config -> String -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
...
replaceNamespacedReplicaSetStatus :: forall e. Config -> String -> String -> AppsV1.ReplicaSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.ReplicaSet)
