...
createNamespacedStatefulSet :: forall e. Config -> String -> AppsV1.StatefulSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSet)
...
listNamespacedStatefulSet :: forall e. Config -> String -> ListNamespacedStatefulSetOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSetList)
listNamespacedStatefulSet cfg namespace options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/statefulsets" <> formatQueryString options

-- | list or watch objects of kind StatefulSet
listStatefulSetForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSetList)
...
readNamespacedStatefulSet :: forall e. Config -> String -> String -> ReadNamespacedStatefulSetOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSet)
readNamespacedStatefulSet cfg namespace name options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1/namespaces/" <> namespace <> "/statefulsets/" <> name <> "" <> formatQueryString options

-- | read status of the specified StatefulSet
readNamespacedStatefulSetStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSet)
...
replaceNamespacedStatefulSet :: forall e. Config -> String -> String -> AppsV1.StatefulSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSet)
...
replaceNamespacedStatefulSetStatus :: forall e. Config -> String -> String -> AppsV1.StatefulSet -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1.StatefulSet)
