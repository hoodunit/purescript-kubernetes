...
createNamespacedControllerRevision :: forall e. Config -> String -> AppsV1Beta1.ControllerRevision -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.ControllerRevision)
...
listControllerRevisionForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.ControllerRevisionList)
...
-- | list or watch objects of kind ControllerRevision
listNamespacedControllerRevision :: forall e. Config -> String -> ListNamespacedControllerRevisionOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.ControllerRevisionList)
...
readNamespacedControllerRevision :: forall e. Config -> String -> String -> ReadNamespacedControllerRevisionOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.ControllerRevision)
readNamespacedControllerRevision cfg namespace name options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1beta1/namespaces/" <> namespace <> "/controllerrevisions/" <> name <> "" <> formatQueryString options

-- | replace the specified ControllerRevision
replaceNamespacedControllerRevision :: forall e. Config -> String -> String -> AppsV1Beta1.ControllerRevision -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.ControllerRevision)
