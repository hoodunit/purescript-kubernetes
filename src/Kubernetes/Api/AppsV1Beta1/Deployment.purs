...
-- | create a Deployment
createNamespacedDeployment :: forall e. Config -> String -> AppsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.Deployment)
...
listDeploymentForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.DeploymentList)
...
-- | list or watch objects of kind Deployment
listNamespacedDeployment :: forall e. Config -> String -> ListNamespacedDeploymentOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.DeploymentList)
...
readNamespacedDeployment :: forall e. Config -> String -> String -> ReadNamespacedDeploymentOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.Deployment)
readNamespacedDeployment cfg namespace name options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/apps/v1beta1/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> formatQueryString options

-- | read status of the specified Deployment
readNamespacedDeploymentStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.Deployment)
...
replaceNamespacedDeployment :: forall e. Config -> String -> String -> AppsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.Deployment)
...
replaceNamespacedDeploymentStatus :: forall e. Config -> String -> String -> AppsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status AppsV1Beta1.Deployment)
