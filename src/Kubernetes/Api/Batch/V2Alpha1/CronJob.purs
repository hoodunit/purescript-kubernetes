module Kubernetes.Api.Batch.V2Alpha1.CronJob where
...
import Kubernetes.Api.Batch.V2Alpha1 as BatchV2Alpha1
import Kubernetes.Api.Meta.V1 as MetaV1

-- | create a CronJob
createNamespaced :: forall e. Config -> String -> BatchV2Alpha1.CronJob -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJob)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/batch/v2alpha1/namespaces/" <> namespace <> "/cronjobs" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/batch/v2alpha1/namespaces/" <> namespace <> "/cronjobs/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind CronJob
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJobList)
...
-- | list or watch objects of kind CronJob
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJobList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJob)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/batch/v2alpha1/namespaces/" <> namespace <> "/cronjobs/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified CronJob
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJob)
...
replaceNamespaced :: forall e. Config -> String -> String -> BatchV2Alpha1.CronJob -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJob)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> BatchV2Alpha1.CronJob -> Aff (http :: HTTP | e) (Either MetaV1.Status BatchV2Alpha1.CronJob)
