...
-- | create a CronJob
createNamespaced :: Config -> String -> BatchV1Beta1.CronJob -> Aff (Either MetaV1.Status BatchV1Beta1.CronJob)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status BatchV1Beta1.CronJobList)
...
-- | list or watch objects of kind CronJob
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status BatchV1Beta1.CronJobList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status BatchV1Beta1.CronJob)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/batch/v1beta1/namespaces/" <> namespace <> "/cronjobs/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified CronJob
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status BatchV1Beta1.CronJob)
...
replaceNamespaced :: Config -> String -> String -> BatchV1Beta1.CronJob -> Aff (Either MetaV1.Status BatchV1Beta1.CronJob)
...
replaceNamespacedStatus :: Config -> String -> String -> BatchV1Beta1.CronJob -> Aff (Either MetaV1.Status BatchV1Beta1.CronJob)
