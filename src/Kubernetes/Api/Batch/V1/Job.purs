module Kubernetes.Api.Batch.V1.Job where
...
-- | create a Job
createNamespaced :: Config -> String -> BatchV1.Job -> Aff (Either MetaV1.Status BatchV1.Job)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status BatchV1.JobList)
...
-- | list or watch objects of kind Job
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status BatchV1.JobList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status BatchV1.Job)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/batch/v1/namespaces/" <> namespace <> "/jobs/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Job
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status BatchV1.Job)
...
replaceNamespaced :: Config -> String -> String -> BatchV1.Job -> Aff (Either MetaV1.Status BatchV1.Job)
...
replaceNamespacedStatus :: Config -> String -> String -> BatchV1.Job -> Aff (Either MetaV1.Status BatchV1.Job)
