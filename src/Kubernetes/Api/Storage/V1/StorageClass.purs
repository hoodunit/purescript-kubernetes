...
create :: Config -> StorageV1.StorageClass -> Aff (Either MetaV1.Status StorageV1.StorageClass)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status StorageV1.StorageClassList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status StorageV1.StorageClass)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/storage.k8s.io/v1/storageclasses/{name}" <> Client.formatQueryString options

-- | replace the specified StorageClass
replace :: Config -> StorageV1.StorageClass -> Aff (Either MetaV1.Status StorageV1.StorageClass)
