...
createNamespaced :: Config -> String -> APIExtensionsV1Beta1.NetworkPolicy -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicyList)
...
-- | list or watch objects of kind NetworkPolicy
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicyList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/networkpolicies/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified NetworkPolicy
replaceNamespaced :: Config -> String -> String -> APIExtensionsV1Beta1.NetworkPolicy -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
