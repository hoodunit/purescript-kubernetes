module Kubernetes.Api.Extensions.V1Beta1.NetworkPolicy where
...
createNamespaced :: forall e. Config -> String -> APIExtensionsV1Beta1.NetworkPolicy -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/networkpolicies" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/networkpolicies/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind NetworkPolicy
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicyList)
...
-- | list or watch objects of kind NetworkPolicy
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicyList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/networkpolicies/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified NetworkPolicy
replaceNamespaced :: forall e. Config -> String -> String -> APIExtensionsV1Beta1.NetworkPolicy -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.NetworkPolicy)
