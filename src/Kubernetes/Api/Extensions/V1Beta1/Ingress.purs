module Kubernetes.Api.Extensions.V1Beta1.Ingress where
...
-- | create an Ingress
createNamespaced :: Config -> String -> APIExtensionsV1Beta1.Ingress -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Ingress)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.IngressList)
...
-- | list or watch objects of kind Ingress
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.IngressList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Ingress)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/ingresses/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Ingress
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Ingress)
...
replaceNamespaced :: Config -> String -> String -> APIExtensionsV1Beta1.Ingress -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Ingress)
...
replaceNamespacedStatus :: Config -> String -> String -> APIExtensionsV1Beta1.Ingress -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Ingress)
