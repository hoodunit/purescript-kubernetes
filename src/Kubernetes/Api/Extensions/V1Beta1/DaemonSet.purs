module Kubernetes.Api.Extensions.V1Beta1.DaemonSet where
...
-- | create a DaemonSet
createNamespaced :: forall e. Config -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/daemonsets" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/daemonsets/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind DaemonSet
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSetList)
...
-- | list or watch objects of kind DaemonSet
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSetList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/daemonsets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified DaemonSet
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
replaceNamespaced :: forall e. Config -> String -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
