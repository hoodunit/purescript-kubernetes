...
-- | create a DaemonSet
createNamespaced :: Config -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSetList)
...
-- | list or watch objects of kind DaemonSet
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSetList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/daemonsets/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified DaemonSet
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
replaceNamespaced :: Config -> String -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
...
replaceNamespacedStatus :: Config -> String -> String -> APIExtensionsV1Beta1.DaemonSet -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DaemonSet)
