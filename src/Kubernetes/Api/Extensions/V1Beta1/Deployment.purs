module Kubernetes.Api.Extensions.V1Beta1.Deployment where
...
-- | create a Deployment
createNamespaced :: forall e. Config -> String -> APIExtensionsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/deployments" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind Deployment
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DeploymentList)
...
-- | list or watch objects of kind Deployment
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.DeploymentList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Deployment
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
replaceNamespaced :: forall e. Config -> String -> String -> APIExtensionsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> APIExtensionsV1Beta1.Deployment -> Aff (http :: HTTP | e) (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
