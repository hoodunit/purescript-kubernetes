...
-- | create a Deployment
createNamespaced :: Config -> String -> APIExtensionsV1Beta1.Deployment -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DeploymentList)
...
-- | list or watch objects of kind Deployment
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.DeploymentList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/extensions/v1beta1/namespaces/" <> namespace <> "/deployments/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Deployment
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
replaceNamespaced :: Config -> String -> String -> APIExtensionsV1Beta1.Deployment -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
...
replaceNamespacedStatus :: Config -> String -> String -> APIExtensionsV1Beta1.Deployment -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.Deployment)
