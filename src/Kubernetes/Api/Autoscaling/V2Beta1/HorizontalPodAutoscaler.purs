module Kubernetes.Api.Autoscaling.V2Beta1.HorizontalPodAutoscaler where
...
import Kubernetes.Api.Autoscaling.V2Beta1 as AutoscalingV2Beta1
import Kubernetes.Api.Meta.V1 as MetaV1

-- | create a HorizontalPodAutoscaler
createNamespaced :: forall e. Config -> String -> AutoscalingV2Beta1.HorizontalPodAutoscaler -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscaler)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/apis/autoscaling/v2beta1/namespaces/" <> namespace <> "/horizontalpodautoscalers" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/apis/autoscaling/v2beta1/namespaces/" <> namespace <> "/horizontalpodautoscalers/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind HorizontalPodAutoscaler
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscalerList)
...
-- | list or watch objects of kind HorizontalPodAutoscaler
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscalerList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscaler)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/autoscaling/v2beta1/namespaces/" <> namespace <> "/horizontalpodautoscalers/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified HorizontalPodAutoscaler
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscaler)
...
replaceNamespaced :: forall e. Config -> String -> String -> AutoscalingV2Beta1.HorizontalPodAutoscaler -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscaler)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> AutoscalingV2Beta1.HorizontalPodAutoscaler -> Aff (http :: HTTP | e) (Either MetaV1.Status AutoscalingV2Beta1.HorizontalPodAutoscaler)
