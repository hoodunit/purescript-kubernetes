...
createNamespaced :: Config -> String -> AutoscalingV1.HorizontalPodAutoscaler -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscaler)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscalerList)
...
-- | list or watch objects of kind HorizontalPodAutoscaler
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscalerList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscaler)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/autoscaling/v1/namespaces/" <> namespace <> "/horizontalpodautoscalers/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified HorizontalPodAutoscaler
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscaler)
...
replaceNamespaced :: Config -> String -> String -> AutoscalingV1.HorizontalPodAutoscaler -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscaler)
...
replaceNamespacedStatus :: Config -> String -> String -> AutoscalingV1.HorizontalPodAutoscaler -> Aff (Either MetaV1.Status AutoscalingV1.HorizontalPodAutoscaler)
