...
createClusterRoleBinding :: forall e. Config -> RbacV1Beta1.ClusterRoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.ClusterRoleBinding)
...
deleteClusterRoleBinding cfg body options = makeRequest (delete cfg url (Just encodedBody))
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}" <> formatQueryString options
    encodedBody = encodeJSON body
...
deleteCollectionClusterRoleBinding cfg options = makeRequest (delete cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings" <> formatQueryString options
...
readClusterRoleBinding :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.ClusterRoleBinding)
...
replaceClusterRoleBinding :: forall e. Config -> RbacV1Beta1.ClusterRoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.ClusterRoleBinding)
