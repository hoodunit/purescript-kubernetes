module Kubernetes.Api.RbacV1Beta1.RoleBinding where
...
createNamespacedRoleBinding :: forall e. Config -> RbacV1Beta1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
deleteCollectionNamespacedRoleBinding cfg options = makeRequest (delete cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings" <> formatQueryString options
...
deleteNamespacedRoleBinding cfg body options = makeRequest (delete cfg url (Just encodedBody))
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}" <> formatQueryString options
    encodedBody = encodeJSON body
...
listNamespacedRoleBinding :: forall e. Config -> ListNamespacedRoleBindingOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
listNamespacedRoleBinding cfg options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings" <> formatQueryString options

-- | list or watch objects of kind RoleBinding
listRoleBindingForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBindingList)
...
readNamespacedRoleBinding :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
...
replaceNamespacedRoleBinding :: forall e. Config -> RbacV1Beta1.RoleBinding -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleBinding)
