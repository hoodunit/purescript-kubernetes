module Kubernetes.Api.RbacV1Beta1.Role where
...
-- | create a Role
createNamespacedRole :: forall e. Config -> RbacV1Beta1.Role -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.Role)
...
deleteCollectionNamespacedRole cfg options = makeRequest (delete cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles" <> formatQueryString options
...
deleteNamespacedRole cfg body options = makeRequest (delete cfg url (Just encodedBody))
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}" <> formatQueryString options
    encodedBody = encodeJSON body
...
listNamespacedRole :: forall e. Config -> ListNamespacedRoleOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleList)
listNamespacedRole cfg options = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles" <> formatQueryString options

-- | list or watch objects of kind Role
listRoleForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.RoleList)
listRoleForAllNamespaces cfg = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1beta1/roles"

-- | read the specified Role
readNamespacedRole :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.Role)
...
replaceNamespacedRole :: forall e. Config -> RbacV1Beta1.Role -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1Beta1.Role)
