module Kubernetes.Api.Authorization.V1.SubjectAccessReview where
...
create :: Config -> AuthorizationV1.SubjectAccessReview -> Aff (Either MetaV1.Status AuthorizationV1.SubjectAccessReview)
