module Kubernetes.Api.Authorization.V1Beta1.LocalSubjectAccessReview where
...
createNamespaced :: Config -> AuthorizationV1Beta1.LocalSubjectAccessReview -> Aff (Either MetaV1.Status AuthorizationV1Beta1.LocalSubjectAccessReview)
