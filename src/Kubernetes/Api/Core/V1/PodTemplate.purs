...
createNamespaced :: Config -> String -> CoreV1.PodTemplate -> Aff (Either MetaV1.Status CoreV1.PodTemplate)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.PodTemplateList)
...
-- | list or watch objects of kind PodTemplate
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.PodTemplateList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.PodTemplate)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/podtemplates/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified PodTemplate
replaceNamespaced :: Config -> String -> String -> CoreV1.PodTemplate -> Aff (Either MetaV1.Status CoreV1.PodTemplate)
