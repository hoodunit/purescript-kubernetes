module Kubernetes.Api.Core.V1.PodTemplate where
...
createNamespaced :: forall e. Config -> String -> CoreV1.PodTemplate -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PodTemplate)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/podtemplates" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/api/v1/namespaces/" <> namespace <> "/podtemplates/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind PodTemplate
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PodTemplateList)
...
-- | list or watch objects of kind PodTemplate
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PodTemplateList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PodTemplate)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/podtemplates/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified PodTemplate
replaceNamespaced :: forall e. Config -> String -> String -> CoreV1.PodTemplate -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PodTemplate)
