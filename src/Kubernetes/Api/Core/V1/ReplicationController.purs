module Kubernetes.Api.Core.V1.ReplicationController where
...
createNamespaced :: forall e. Config -> String -> CoreV1.ReplicationController -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationController)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/replicationcontrollers" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/api/v1/namespaces/" <> namespace <> "/replicationcontrollers/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind ReplicationController
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationControllerList)
...
-- | list or watch objects of kind ReplicationController
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationControllerList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationController)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/replicationcontrollers/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ReplicationController
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationController)
...
replaceNamespaced :: forall e. Config -> String -> String -> CoreV1.ReplicationController -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationController)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> CoreV1.ReplicationController -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ReplicationController)
