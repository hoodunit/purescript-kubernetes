...
createNamespaced :: Config -> String -> CoreV1.ReplicationController -> Aff (Either MetaV1.Status CoreV1.ReplicationController)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.ReplicationControllerList)
...
-- | list or watch objects of kind ReplicationController
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ReplicationControllerList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ReplicationController)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/replicationcontrollers/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ReplicationController
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status CoreV1.ReplicationController)
...
replaceNamespaced :: Config -> String -> String -> CoreV1.ReplicationController -> Aff (Either MetaV1.Status CoreV1.ReplicationController)
...
replaceNamespacedStatus :: Config -> String -> String -> CoreV1.ReplicationController -> Aff (Either MetaV1.Status CoreV1.ReplicationController)
