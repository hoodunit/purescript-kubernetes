module Kubernetes.Api.Core.V1.Secret where
...
-- | create a Secret
createNamespaced :: forall e. Config -> String -> CoreV1.Secret -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.Secret)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/secrets" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/api/v1/namespaces/" <> namespace <> "/secrets/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind Secret
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.SecretList)
...
-- | list or watch objects of kind Secret
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.SecretList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.Secret)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/secrets/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified Secret
replaceNamespaced :: forall e. Config -> String -> String -> CoreV1.Secret -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.Secret)
