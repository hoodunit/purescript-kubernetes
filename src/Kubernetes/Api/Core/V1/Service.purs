...
-- | create a Service
createNamespaced :: Config -> String -> CoreV1.Service -> Aff (Either MetaV1.Status CoreV1.Service)
...
-- | delete a Service
deleteNamespaced :: Config -> String -> String -> Aff (Either MetaV1.Status MetaV1.Status)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.ServiceList)
...
-- | list or watch objects of kind Service
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ServiceList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.Service)
...
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status CoreV1.Service)
...
replaceNamespaced :: Config -> String -> String -> CoreV1.Service -> Aff (Either MetaV1.Status CoreV1.Service)
...
replaceNamespacedStatus :: Config -> String -> String -> CoreV1.Service -> Aff (Either MetaV1.Status CoreV1.Service)
