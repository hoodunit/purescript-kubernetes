module Kubernetes.Api.Core.V1.Namespace where
...
-- | create a Namespace
create :: Config -> CoreV1.Namespace -> Aff (Either MetaV1.Status CoreV1.Namespace)
...
-- | delete a Namespace
delete :: Config -> String -> MetaV1.DeleteOptions -> DeleteOptions -> Aff (Either MetaV1.Status CoreV1.Namespace)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status CoreV1.NamespaceList)
...
read :: Config -> String -> ReadOptions -> Aff (Either MetaV1.Status CoreV1.Namespace)
read cfg name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified Namespace
readStatus :: Config -> String -> Aff (Either MetaV1.Status CoreV1.Namespace)
readStatus cfg name = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> name <> "/status"

-- | replace the specified Namespace
replace :: Config -> String -> CoreV1.Namespace -> Aff (Either MetaV1.Status CoreV1.Namespace)
...
replaceFinalize :: Config -> String -> CoreV1.Namespace -> Aff (Either MetaV1.Status CoreV1.Namespace)
...
replaceStatus :: Config -> String -> CoreV1.Namespace -> Aff (Either MetaV1.Status CoreV1.Namespace)
