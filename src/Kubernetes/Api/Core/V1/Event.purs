...
-- | create an Event
createNamespaced :: Config -> String -> CoreV1.Event -> Aff (Either MetaV1.Status CoreV1.Event)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.EventList)
...
-- | list or watch objects of kind Event
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.EventList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.Event)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/events/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified Event
replaceNamespaced :: Config -> String -> String -> CoreV1.Event -> Aff (Either MetaV1.Status CoreV1.Event)
