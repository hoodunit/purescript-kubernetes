...
-- | create a ConfigMap
createNamespaced :: Config -> String -> CoreV1.ConfigMap -> Aff (Either MetaV1.Status CoreV1.ConfigMap)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.ConfigMapList)
...
-- | list or watch objects of kind ConfigMap
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ConfigMapList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ConfigMap)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/configmaps/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified ConfigMap
replaceNamespaced :: Config -> String -> String -> CoreV1.ConfigMap -> Aff (Either MetaV1.Status CoreV1.ConfigMap)
