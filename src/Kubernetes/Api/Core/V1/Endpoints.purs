...
-- | create Endpoints
createNamespaced :: Config -> String -> CoreV1.Endpoints -> Aff (Either MetaV1.Status CoreV1.Endpoints)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.EndpointsList)
...
-- | list or watch objects of kind Endpoints
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.EndpointsList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.Endpoints)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/endpoints/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified Endpoints
replaceNamespaced :: Config -> String -> String -> CoreV1.Endpoints -> Aff (Either MetaV1.Status CoreV1.Endpoints)
