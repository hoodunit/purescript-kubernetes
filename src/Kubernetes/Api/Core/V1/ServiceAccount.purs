module Kubernetes.Api.Core.V1.ServiceAccount where
...
createNamespaced :: Config -> String -> CoreV1.ServiceAccount -> Aff (Either MetaV1.Status CoreV1.ServiceAccount)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.ServiceAccountList)
...
-- | list or watch objects of kind ServiceAccount
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ServiceAccountList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ServiceAccount)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/serviceaccounts/" <> name <> "" <> Client.formatQueryString options

-- | replace the specified ServiceAccount
replaceNamespaced :: Config -> String -> String -> CoreV1.ServiceAccount -> Aff (Either MetaV1.Status CoreV1.ServiceAccount)
