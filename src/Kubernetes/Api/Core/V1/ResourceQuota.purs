module Kubernetes.Api.Core.V1.ResourceQuota where
...
createNamespaced :: forall e. Config -> String -> CoreV1.ResourceQuota -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuota)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/resourcequotas" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/api/v1/namespaces/" <> namespace <> "/resourcequotas/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind ResourceQuota
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuotaList)
...
-- | list or watch objects of kind ResourceQuota
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuotaList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuota)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/resourcequotas/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ResourceQuota
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuota)
...
replaceNamespaced :: forall e. Config -> String -> String -> CoreV1.ResourceQuota -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuota)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> CoreV1.ResourceQuota -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.ResourceQuota)
