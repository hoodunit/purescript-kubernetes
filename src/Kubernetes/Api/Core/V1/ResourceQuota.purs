...
createNamespaced :: Config -> String -> CoreV1.ResourceQuota -> Aff (Either MetaV1.Status CoreV1.ResourceQuota)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.ResourceQuotaList)
...
-- | list or watch objects of kind ResourceQuota
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ResourceQuotaList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.ResourceQuota)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/resourcequotas/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified ResourceQuota
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status CoreV1.ResourceQuota)
...
replaceNamespaced :: Config -> String -> String -> CoreV1.ResourceQuota -> Aff (Either MetaV1.Status CoreV1.ResourceQuota)
...
replaceNamespacedStatus :: Config -> String -> String -> CoreV1.ResourceQuota -> Aff (Either MetaV1.Status CoreV1.ResourceQuota)
