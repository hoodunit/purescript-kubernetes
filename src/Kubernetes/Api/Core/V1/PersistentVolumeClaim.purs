...
createNamespaced :: Config -> String -> CoreV1.PersistentVolumeClaim -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
listForAllNamespaces :: Config -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaimList)
...
-- | list or watch objects of kind PersistentVolumeClaim
listNamespaced :: Config -> String -> ListNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaimList)
...
readNamespaced :: Config -> String -> String -> ReadNamespacedOptions -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/persistentvolumeclaims/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified PersistentVolumeClaim
readNamespacedStatus :: Config -> String -> String -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
replaceNamespaced :: Config -> String -> String -> CoreV1.PersistentVolumeClaim -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
replaceNamespacedStatus :: Config -> String -> String -> CoreV1.PersistentVolumeClaim -> Aff (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
