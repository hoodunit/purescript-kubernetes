module Kubernetes.Api.Core.V1.PersistentVolumeClaim where
...
createNamespaced :: forall e. Config -> String -> CoreV1.PersistentVolumeClaim -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
deleteCollectionNamespaced cfg namespace options = Client.makeRequest (Client.delete cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/persistentvolumeclaims" <> Client.formatQueryString options
...
deleteNamespaced cfg namespace name body options = Client.makeRequest (Client.delete cfg url (Just encodedBody))
  where
    url = "/api/v1/namespaces/" <> namespace <> "/persistentvolumeclaims/" <> name <> "" <> Client.formatQueryString options
    encodedBody = encodeJSON body

-- | list or watch objects of kind PersistentVolumeClaim
listForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaimList)
...
-- | list or watch objects of kind PersistentVolumeClaim
listNamespaced :: forall e. Config -> String -> ListNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaimList)
...
readNamespaced :: forall e. Config -> String -> String -> ReadNamespacedOptions -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
readNamespaced cfg namespace name options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/api/v1/namespaces/" <> namespace <> "/persistentvolumeclaims/" <> name <> "" <> Client.formatQueryString options

-- | read status of the specified PersistentVolumeClaim
readNamespacedStatus :: forall e. Config -> String -> String -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
replaceNamespaced :: forall e. Config -> String -> String -> CoreV1.PersistentVolumeClaim -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
...
replaceNamespacedStatus :: forall e. Config -> String -> String -> CoreV1.PersistentVolumeClaim -> Aff (http :: HTTP | e) (Either MetaV1.Status CoreV1.PersistentVolumeClaim)
