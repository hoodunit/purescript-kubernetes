...
create :: Config -> SchedulingV1Alpha1.PriorityClass -> Aff (Either MetaV1.Status SchedulingV1Alpha1.PriorityClass)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status SchedulingV1Alpha1.PriorityClassList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status SchedulingV1Alpha1.PriorityClass)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}" <> Client.formatQueryString options

-- | replace the specified PriorityClass
replace :: Config -> SchedulingV1Alpha1.PriorityClass -> Aff (Either MetaV1.Status SchedulingV1Alpha1.PriorityClass)
