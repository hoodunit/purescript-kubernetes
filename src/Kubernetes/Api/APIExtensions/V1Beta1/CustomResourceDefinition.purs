module Kubernetes.Api.APIExtensions.V1Beta1.CustomResourceDefinition where
...
create :: Config -> APIExtensionsV1Beta1.CustomResourceDefinition -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.CustomResourceDefinition)
...
list :: Config -> ListOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.CustomResourceDefinitionList)
...
read :: Config -> ReadOptions -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.CustomResourceDefinition)
read cfg options = Client.makeRequest (Client.get cfg url Nothing)
  where
    url = "/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}" <> Client.formatQueryString options

-- | replace the specified CustomResourceDefinition
replace :: Config -> APIExtensionsV1Beta1.CustomResourceDefinition -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.CustomResourceDefinition)
...
replaceStatus :: Config -> APIExtensionsV1Beta1.CustomResourceDefinition -> Aff (Either MetaV1.Status APIExtensionsV1Beta1.CustomResourceDefinition)
