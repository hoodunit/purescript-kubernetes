...
-- | create a Role
createNamespacedRole :: forall e. Config -> RbacV1.Role -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1.Role)
...
-- | list or watch objects of kind Role
listRoleForAllNamespaces :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1.RoleList)
listRoleForAllNamespaces cfg = makeRequest (get cfg url Nothing)
  where
    url = "/apis/rbac.authorization.k8s.io/v1/roles"

-- | read the specified Role
readNamespacedRole :: forall e. Config -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1.Role)
...
replaceNamespacedRole :: forall e. Config -> RbacV1.Role -> Aff (http :: HTTP | e) (Either MetaV1.Status RbacV1.Role)
